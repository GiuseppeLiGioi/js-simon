...
Dopo 30 secondi i numeri scompaiono Visualizzare in pagina 5 numeri casuali.e appaiono invece 5 input in cui l'utente deve inserire i numeri che ha visto precedentemente, nell'ordine che preferisce.
...
if(counter === 0){
    ...
    divHtml.innerHTML="Hai finito il tempo a disposizione per memorizzare i numeri";
}else{
